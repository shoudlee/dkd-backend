...
public class TbChannelController extends BaseController
{
    ...
    @PostMapping("/export")
    public void export(HttpServletResponse response, TbChannel tbChannel)
    {
        List<TbChannel> list = tbChannelService.selectTbChannelList(tbChannel);
    ...
    {
        return success(tbChannelService.selectTbChannelById(id));
    }
    ...
    @PostMapping
    public AjaxResult add(@RequestBody TbChannel tbChannel)
    {
    ...
    @PutMapping
    public AjaxResult edit(@RequestBody TbChannel tbChannel)
    {
    ...
    public AjaxResult lisetByInnerCode(@PathVariable("innerCode") String innerCode) {
        List<ChannelVo> voList = tbChannelService.selectChannelVoListByInnerCode(innerCode);
    ...
    public AjaxResult setChannel(@RequestBody ChannelConfigDto channelConfigDto) {
        return toAjax(tbChannelService.setChannel(channelConfigDto));
    }
}
