...
INSERT INTO `sys_config` VALUES (5, '账号自助-是否开启用户注册功能', 'sys.account.registerUser', 'false', 'Y', 'admin', '2024-10-23 20:28:39', '', NULL, '是否开启注册用户功能（true开启，false关闭）');
...
INSERT INTO `sys_menu` VALUES (2033, '售货机货道', 2026, 1, 'channel', 'manage/channel/index', NULL, 1, 0, 'C', '0', '0', 'manage:channel:list', '#', 'admin', '2024-10-28 21:16:59', '', NULL, '售货机货道菜单');
INSERT INTO `sys_menu` VALUES (2034, '售货机货道查询', 2033, 1, '#', '', NULL, 1, 0, 'F', '0', '0', 'manage:channel:query', '#', 'admin', '2024-10-28 21:16:59', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2035, '售货机货道新增', 2033, 2, '#', '', NULL, 1, 0, 'F', '0', '0', 'manage:channel:add', '#', 'admin', '2024-10-28 21:16:59', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2036, '售货机货道修改', 2033, 3, '#', '', NULL, 1, 0, 'F', '0', '0', 'manage:channel:edit', '#', 'admin', '2024-10-28 21:16:59', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2037, '售货机货道删除', 2033, 4, '#', '', NULL, 1, 0, 'F', '0', '0', 'manage:channel:remove', '#', 'admin', '2024-10-28 21:16:59', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2038, '售货机货道导出', 2033, 5, '#', '', NULL, 1, 0, 'F', '0', '0', 'manage:channel:export', '#', 'admin', '2024-10-28 21:16:59', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2045, '设备', 2026, 1, 'vm', 'manage/vm/index', NULL, 1, 0, 'C', '0', '0', 'manage:vm:list', '#', 'admin', '2024-10-28 21:17:17', '', NULL, '设备菜单');
...
) ENGINE = InnoDB AUTO_INCREMENT = 160 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2024-10-28 23:49:41', 'admin', '2024-10-23 20:28:38', '', '2024-10-28 23:49:41', '管理员');
